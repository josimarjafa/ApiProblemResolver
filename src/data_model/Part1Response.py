...
class Arguments:
    ...
    def __init__(self, fare_id: str) -> None:
        self.fare_id = fare_id

    @staticmethod
    def from_dict(obj: Any) -> 'Arguments':
        assert isinstance(obj, dict)
        fare_id = from_str(obj.get("fare_id"))
        return Arguments(fare_id)

    def to_dict(self) -> dict:
        result: dict = {"fare_id": from_str(self.fare_id)}
        return result
...
class Data:
    ...
    def __init__(self, total_seconds: str) -> None:
        self.total_seconds = total_seconds

    @staticmethod
    def from_dict(obj: Any) -> 'Data':
        assert isinstance(obj, dict)
        total_seconds = from_str(obj.get("total_seconds"))
        return Data(total_seconds)

    def to_dict(self) -> dict:
        result: dict = {"total_seconds": from_str(self.total_seconds)}
        return result
...
class Part1Response:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'Part1Response':
        assert isinstance(obj, dict)
        token = from_str(obj.get("token"))
        ...
        return Part1Response(token, description, arguments, expected_return_shape, millisecond_time_limit, input)
...
def part1_response_from_dict(s: Any) -> Part1Response:
    return Part1Response.from_dict(s)


def part1_response_to_dict(x: Part1Response) -> Any:
    return to_class(Part1Response, x)
